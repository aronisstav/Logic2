...
\begin{frame}
  ...
  Αν έχουμε την αναδρομική συνάρτηση $F_{n+1}(y,x_1,\ldots,x_n)$ \\
  Τότε και η:
    $$
...
\begin{frame}
  ...
  κλειστότητα της σχέσης $\rightarrow _\beta$ \\ Συνεπώς είναι κλειστή
  για τους κανόνες:
  \begin{itemize}
...
\begin{frame}
        ...
        \begin{itemize}
                ...
                $$
                \pause
                \item \textbf{Πόρισμα}: Ο $\lambda$-λογισμός ως θεωρία της $\beta$-ισότητας είναι συνεπής θεωρία.
                \pause
...
% xelatex -interaction=nonstopmode utf8presentation.tex; evince utf8presentation.pdf
