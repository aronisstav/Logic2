...
\begin{frame}
        ...
        \begin{itemize}
            ...
            \item Η σχέση $\rightarrow ^{\star} _{\beta}$ είναι η μεταβατική και αυτοπαθής κλειστότητα της σχέσης
                  $\rightarrow _\beta$ \\ Συνεπώς είναι κλειστή για τους κανόνες: 
            \pause
            \item \[P \rightarrow  _{\beta} P ^{\prime} \Rightarrow P \rightarrow ^{\star}  _{\beta} P ^{\prime}\]
            \pause
            \item \[P \rightarrow ^{\star} _{\beta} P ^{\prime} \cap P ^{\prime} \rightarrow ^{\star} _{\beta} P ^{\prime \prime}
                  \Rightarrow P \rightarrow ^{\star} _{\beta} P ^{\prime \prime}\]
			\pause
            \item \[P \rightarrow ^{\star} _{\beta} P\]
